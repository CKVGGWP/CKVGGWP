            ...
            <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5">
                        <h2>Hobbies</h2>
                        <ul>
                            <li><i class="icofont-rounded-right"></i><strong>Programming/Coding</strong></li>
                            <li><i class="icofont-rounded-right"></i><strong>Playing Games</strong></li>
                            <li><i class="icofont-rounded-right"></i><strong>Playing the Guitar</strong></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<section id="skills" class="skills section-bg">
    <div class="container">
        ...
        <div class="row">
            <div class="skills-column" data-aos="fade-left">
                <h2 class="text-center mb-3">Front End</h2>
            ...
            <div class="skills-column" data-aos="fade-right" data-aos-delay="100">
            ...
            <div class="skills-column" data-aos="fade-left" data-aos-delay="200">
                <h2 class="text-center mb-3 mt-5">Other Programming Languages</h2>
                <div class="col-md-12 skills-content d-flex flex-wrap align-items-center justify-content-center">
                    <i class="devicon-csharp-plain-wordmark colored"></i>
                </div>
            </div>
            <div class="skills-column" data-aos="fade-right" data-aos-delay="300">
        ...
        <div class="row">
            <div class="col-lg-6" data-aos="fade-up">
                ...
                <div class="resume-item">
                    ...
                    <h5>2018 - 2022</h5>
                    <p>Batangas State University JPLPC-Malvar</p>
                    <p><em>Poblacion, Malvar, Batangas, PH</em></p>
                </div>
                <div class="resume-item">
                    <h4>Elementary (Grade 3) to Senior High School (HUMSS Strand)</h4>
                    <h5>2008 - 2018</h5>
    ...
    <div class="container">
        ...
        <div class="row" data-aos="fade-in">
            ...
            <div class="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch">
                <form action="controller/controller_email.php" method="POST" id="send-email" class="php-email-form">
                    <div class="row">
